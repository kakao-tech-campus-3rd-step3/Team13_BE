...
public class SubscribeController {
    ...
    public ResponseEntity<Void> addTimePeriod(
        @Login Member member, @PathVariable TimePeriod timePeriod) {
    ...
    public ResponseEntity<Void> addSport(
        @Login Member member, @PathVariable Long sportId) {
    ...
    public ResponseEntity<SportsResponse> getSports(
        @Login Member member) {
        return ResponseEntity.ok(
            subscribeService.getSportsByMember(member)
        );
    }

    @GetMapping("/interests/times")
    public ResponseEntity<TimePeriodsResponse> getTimes(
        @Login Member member) {
        return ResponseEntity.ok(
            subscribeService.getTimesByMember(member)
        );
    }
}
